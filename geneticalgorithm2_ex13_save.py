...
model.run(no_plot=False, start_generation={'variables': samples, 'scores': None}, save_last_generation_as=filename)
...
model.run(no_plot=False, start_generation=filename)